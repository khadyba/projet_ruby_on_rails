class BlaguesController < ApplicationController
  ...
  def update
    ...
    # Méthode pour supprimer une blague
    def destroy
      @blagues = Blague.find(params[:id])
      puts "Blague à supprimer : #{@blague.inspect}"
      @blagues.destroy
      redirect_to blagues_path, notice: "La blague a été supprimée avec succès."
    end
