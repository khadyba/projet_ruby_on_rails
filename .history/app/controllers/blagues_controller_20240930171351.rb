class BlaguesController < ApplicationController
    ...
    # methode pour la logique de modifications de la blague
   # Méthode pour la logique de modification de la blague
def update
  @blague = Blague.find(params[:id])  # Récupère la blague à modifier
...
def blagues_params
  params.require(:blague).permit(:nom, :contenue, :auteur)  # Définit les paramètres autorisés pour la mise à jour
end
